"""
Result Formatter - Format MCP responses for chat
...
class ResultFormatter:
    """Formatter for MCP responses and other outputs."""
    ...
    def format_tool_list(self, tools: List[Any]) -> str:
        ...
        """
        if not tools:
            return "No tools available. Make sure you're connected to an MCP server."
    ...
    def format_not_connected_error(self) -> str:
        ...
        return (
            ...
            "Use `connect [url]` to connect to an MCP server."
        )
